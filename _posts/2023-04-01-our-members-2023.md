...
{% include profile.html type="start" %}
    {% include profile.html github="hikaritcs" img="default.jpg" name="田中 日加吏" org="さすらいの旅人" %}
    {% include profile.html github="Hiro010301" img="default.jpg" name="織田 大幹" org="さすらいの旅人" %}
    {% include profile.html github="kantayamadamagic" img="default.jpg" name="山田 寛太" org="さすらいの旅人" %}
